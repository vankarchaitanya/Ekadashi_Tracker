            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen p-6">
                ...
                <div className="w-full max-w-md">
                    <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8">
                        ...
                        <p className="text-gray-300 mb-8 font-[--font-sans]">
                            Sign in to continue tracking your events.
                        </p>
                        ...
                        <form action={formAction} className="space-y-5">
                            <input
                                ...
                                className="w-full px-4 py-3  font-[--font-sans] rounded-2xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#fcca46] transition-all duration-300"
                            />
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 font-[--font-sans] rounded-2xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#fe7f2d] transition-all duration-300"
                            />
                                {state?.error && (
        <div className="rounded-md px-3 py-2 text-sm font-[--font-mono] text-[--accent]">
          {state.error}
        </div>
      )}
